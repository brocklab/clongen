...
echo "linking to references folder"

mkdir -p ./references
ln -s ../$gtf_filtered ./references/genes.gtf
ln -s ../$fasta_modified ./references/genome.fa
